...
export const translations: TranslationMap = {
  en: {
    ...
    "header.statusFilter.active": "Active",
    "header.statusFilter.all": "All",
    ...
    "addSubscription.fields.price.monthly": "Monthly price",
    "addSubscription.fields.price.halfYearly": "Half-yearly price",
    "addSubscription.fields.price.yearly": "Yearly price",
    "addSubscription.fields.price.custom": "Total price for period",
    "addSubscription.fields.avgMonthlyCost": "Average monthly cost",
    ...
    "editSubscription.fields.price.monthly": "Monthly price",
    "editSubscription.fields.price.halfYearly": "Half-yearly price",
    "editSubscription.fields.price.yearly": "Yearly price",
    "editSubscription.fields.price.custom": "Total price for period",
    "editSubscription.fields.avgMonthlyCost": "Average monthly cost",
    ...
    "settings.section.themeColors": "Theme Colors",
    "settings.themeColors.description":
      "Customize accent colors for dark and light themes.",
    "settings.themeColors.darkAccent": "Dark Theme Accent",
    "settings.themeColors.lightAccent": "Light Theme Accent",
    "settings.themeColors.reset": "Reset to defaults",
    ...
    "landing.hero.card.title": "Usage overview",
    "landing.hero.card.session": "Active subscriptions",
    "landing.hero.card.focus": "Key features",
  ...
  es: {
    ...
    "header.statusFilter.active": "Activas",
    "header.statusFilter.all": "Todas",
    ...
    "addSubscription.fields.price.monthly": "Precio mensual",
    "addSubscription.fields.price.halfYearly": "Precio semestral",
    "addSubscription.fields.price.yearly": "Precio anual",
    "addSubscription.fields.price.custom": "Precio total del período",
    "addSubscription.fields.avgMonthlyCost": "Costo mensual promedio",
    ...
    "editSubscription.fields.price.monthly": "Precio mensual",
    "editSubscription.fields.price.halfYearly": "Precio semestral",
    "editSubscription.fields.price.yearly": "Precio anual",
    "editSubscription.fields.price.custom": "Precio total del período",
    "editSubscription.fields.avgMonthlyCost": "Costo mensual promedio",
    ...
    "settings.section.themeColors": "Colores del Tema",
    "settings.themeColors.description":
      "Personaliza los colores de acento para los temas claro y oscuro.",
    "settings.themeColors.darkAccent": "Acento del Tema Oscuro",
    "settings.themeColors.lightAccent": "Acento del Tema Claro",
    "settings.themeColors.reset": "Restablecer valores predeterminados",
    ...
    "landing.hero.card.title": "Resumen de uso",
    "landing.hero.card.session": "Suscripciones activas",
    "landing.hero.card.focus": "Funciones principales",
    "landing.hero.card.description":
    ...
    "landing.hero.card.taskOne":
      "Revisa los costos de herramientas de IA antes de renovar",
    "landing.hero.card.taskTwo": "Compara planes de plataformas para ahorrar",
  ...
  "zh-TW": {
    ...
    "header.statusFilter.active": "進行中",
    "header.statusFilter.all": "所有",
    ...
    "addSubscription.fields.price.monthly": "月價格",
    "addSubscription.fields.price.halfYearly": "半年價格",
    "addSubscription.fields.price.yearly": "年價格",
    "addSubscription.fields.price.custom": "週期總價格",
    "addSubscription.fields.avgMonthlyCost": "平均每月花費",
    ...
    "editSubscription.fields.price.monthly": "月價格",
    "editSubscription.fields.price.halfYearly": "半年價格",
    "editSubscription.fields.price.yearly": "年價格",
    "editSubscription.fields.price.custom": "週期總價格",
    "editSubscription.fields.avgMonthlyCost": "平均每月花費",
    ...
    "editSubscription.recordPriceChange": "記錄價格變更",
    "editSubscription.priceEffectiveDate": "新價格生效日",
    "editSubscription.priceChangeHint": "設定新價格的生效日期",
    ...
    "settings.section.themeColors": "主題顏色",
    "settings.themeColors.description": "自訂深色和淺色主題的強調色。",
    "settings.themeColors.darkAccent": "深色主題強調色",
    "settings.themeColors.lightAccent": "淺色主題強調色",
    "settings.themeColors.reset": "重設為預設值",
    "settings.email": "電子郵件",
    ...
    "landing.hero.card.title": "使用概覽",
    "landing.hero.card.session": "使用中的訂閱",
    "landing.hero.card.focus": "主要功能",
    "landing.hero.card.description":
